 ...
 * 
 * Stations are the core organizational unit for radio operations.
 * Each station has unique call letters and can have associated metadata
 * such as frequency, market, format, and ownership information.
 */
@Entity
