...
class VoiceTrackSlot(Base):
    ...
    assigned_dj_id = Column(UUID(as_uuid=True), ForeignKey("users.id"), nullable=True, index=True)
    voice_track_id = Column(UUID(as_uuid=True), ForeignKey("voice_tracks.id"), nullable=True, index=True)
    previous_track_id = Column(UUID(as_uuid=True), ForeignKey("tracks.id"), nullable=True)  # For preview
    next_track_id = Column(UUID(as_uuid=True), ForeignKey("tracks.id"), nullable=True)  # For preview
